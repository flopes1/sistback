...
public class EmployeeHome
{
    ...
    public Employee findById(int id)
    {
        ...
        try
        {
            Employee instance = (Employee) sessionFactory.getCurrentSession().get("com.ssl.dao.imp.Employee", id);
            if (instance == null)
            {
    ...
    public List<Employee> findByExample(Employee instance)
    {
        ...
        try
        {
            List<Employee> results = (List<Employee>) sessionFactory.getCurrentSession()
                    .createCriteria("com.ssl.dao.imp.Employee").add(create(instance)).list();
